    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-pic js-tilt" data-tilt>
          <img src="https://seeklogo.com/images/D/Departemen_Pekerjaan_Umum-logo-7E29323DFE-seeklogo.com.png" alt="Responsive image">
        </div>

        <form class="login100-form validate-form" action="<?php echo base_url('index.php/Welcome/hasil_valid'); ?>" method="post">
          <span class="login100-form-title">
            LOGIN SEBAGAI DINAS PEKERJAAN UMUM
          </span>
