...
<body>
<?php echo form_open("Welcome/tindakLanjutTolak/".$data_laporan->no, array('enctype'=>'multipart/form-data')); ?>
		<table cellpadding="8">
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px; font-size: 16px;" class="input-group">
                                <input type="radio" name="status" value="Tolak Ditindaklanjuti" <?php echo set_radio('status', 'Tolak Ditindaklanjuti'); ?>> Tolak Ditindaklanjuti
                            </div>
