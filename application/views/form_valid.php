...
<body>
<?php echo form_open("Welcome/valid/".$data_laporan->no, array('enctype'=>'multipart/form-data')); ?>
		<table cellpadding="8">
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px; font-size: 16px;" class="input-group">
                                <input type="radio" name="status" value="Divalidasi" <?php echo set_radio('status', 'Divalidasi'); ?>> Divalidasi
                            </div>

                            	<input class="btn btn-success btn-lg btn-block" type="submit" name="submit" value="Ubah">
                            	<a class= "btn btn-danger btn-lg btn-block" href="<?php echo base_url('Welcome/hasil_verif'); ?>">Batal</a>
                            	<?php echo form_close(); ?>
